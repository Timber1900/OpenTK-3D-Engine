...
void main()
{
    ...
    Normal = -(aNormal * mat3(transpose(inverse(model))));
        ...
        public static readonly string Shader2DVert = @"#version 330 core
out vec4 FragColor;
...
void main()
{
    FragColor = lightColor; 
        ...
        public static readonly string Shader2DFrag = @"#version 330 core
layout (location = 0) in vec3 aPos;
...
void main(void)
{
    gl_Position = vec4(aPos, 1f);
        ...
        public static readonly string TextureFrag = @"#version 330 core
out vec4 FragColor;
...
void main()
{
    ...
    FragColor = texture(texture0, textureCords);
        ...
        public static readonly string TextureVert = @"#version 330 core
layout (location = 0) in vec3 aPos;
layout (location = 1) in vec3 aNormal;
...
void main()
{
    ...
    //outputColor = vec4(1f, 1f, 1f, 1f);
        ...
        public static readonly string Texture2DVert = @"#version 330 core
